...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    // Python sends angle * 10 (-235 to 235)
    // Map -235/235 to servo 28/138
    if(raw_angle > 0) {raw_angle = raw_angle + 20;}
    int servo_val = map(raw_angle, -235, 235, 28, 138);
